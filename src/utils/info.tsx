export const DAI = (
  <>
    ...
    sin estar expuestos a la volatilidad extrema que a menudo se asocia con
    otras criptomonedas como Bitcoin o Ethereum. Esto hace que DAI sea útil para
    actividades como el comercio, préstamos, remesas y más, donde la estabilidad
...
export const USDC = (
  <>
    ...
    inteligentes y colaterales en la red Ethereum, USDC se emite y se respalda
    ...
    para una variedad de propósitos, incluidos pagos, comercio, préstamos y más,
    aprovechando la estabilidad del dólar estadounidense sin tener que recurrir
    a sistemas financieros tradicionales.
  </>
);
...
export const USDT = (
  <>
    ...
    estable respaldada por activos, y originalmente afirmaba estar respaldada
    por una cantidad equivalente de dólares estadounidenses en una cuenta
    ...
    criptomonedas en exchanges, como una forma de mantener el valor durante
    ...
    utilizar otras criptomonedas estables como DAI o USDC, que ofrecen un mayor
    nivel de transparencia y descentralización en sus estructuras.
  </>
);
